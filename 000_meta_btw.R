...
# Wahldaten einlesen ------------------------------------------------------
# Wahlkreise Deutschlandweit
source("011_create_btwdata.R")
source("012_load_wkshapes.R")

# Wahlbezirke Jena
source("111_create_btwJena.R")
source("112_load_wbzJhapes.R")
...
print(levels(BTW21J$Gruppenname_1))
pal <- colorFactor(
  palette = c('darkblue', 'black', 'grey25', 'purple', 'forestgreen',"red"),
  domain = BTW21J$Gruppenname_1
)
...
source("mkr_btw21cartogram_Jena.r")
