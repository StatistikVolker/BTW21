...
names(BTW21NLParteien)

# Datensatz Wahlkreisgewinner ---------------------------------------------

BTW21NLRang <- BTW21NLParteien %>%   # den Rang nach Stimmenanzahl
...
BTW21NLwk_shapes <- readOGR( 
  dsn= "Daten/Deutschland" , 
  layer="Geometrie_Wahlkreise_20DBT_VG250_geo",
  verbose=FALSE
)
names(BTW21NLwk_shapes)


# abspeichern -------------------------------------------------------------

save(BTW21NLParteien,BTW21NLRang,BTW21NLwk_shapes, file= "Daten/BTW21NeueLaender.RData")  
